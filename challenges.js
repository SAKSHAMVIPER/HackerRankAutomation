...
let loginclick = await tab.$('[data-analytics="LoginPassword"]');
                                ...
                                let createchallenges =  await tab.$(".btn.btn-green.backbone.pull-right");
                                ...
                                await challengesname.type("newhello");
                                await challengespreview.type("just for fun");
                        ...
                        //  await tab.waitForSelector('[data-analytics="Breadcrumb"]');
                        //   let moveback = await tab.$$('[data-analytics="Breadcrumb"]');
                        //   await moveback[0].click();
                        await page.goBack();
